...
#   - Allows first-run bootstrap when no QS 2.1 archive exists remotely; the local
...
class QSUI:
    ...
    def _build_ui(self):
        ...
        # Keep the entire archive/public control strip on ONE horizontal row.
        ...
        self.archive_box = ttk.Combobox(
            ...
            state="readonly", width=34, font=("Arial", 16, "bold"),
        ...
        tk.Button(
            archive_frame, text="REFRESH ARCHIVES", command=self._refresh_archive_selector,
            bg="#555555", fg="white", font=("Arial", 10, "bold"),
            height=1, padx=8
        ).pack(side=tk.LEFT, padx=4)
        tk.Button(
            archive_frame, text="LIBRARY", command=self._open_library,
            bg="#0088AA", fg="white", font=("Arial", 10, "bold"),
            height=1, padx=10
        ).pack(side=tk.LEFT, padx=4)
        tk.Button(
            archive_frame, text="WHAT CAN THIS DO?", command=self._open_what_can_this_do,
            bg="#AA5500", fg="white", font=("Arial", 10, "bold"),
            height=1, padx=10
        ).pack(side=tk.LEFT, padx=4)
