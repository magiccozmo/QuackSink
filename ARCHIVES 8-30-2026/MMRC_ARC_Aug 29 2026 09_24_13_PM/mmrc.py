...
logger.info("=============================================================")
logger.info("MMRC Luma 2.2 STARTING")
...
class MMRCUI:
    def __init__(self, controller):
        self.root = tk.Tk()
        self.root.title("MMRC Luma 1.8 - Structural DOMAnalyzer")
    ...
    def _build_ui(self):
        tk.Label(
            self.root, text="MULTI-MIND RELAY CORE - Luma 1.7",
                        ...
                        if clean:
                            if self._has_complete_mmrc_frame(raw):
                                ...
                                if len(preview) > 160:
                                    preview = preview[:160] + "..."
                                self.ui.log(
                                    f"[RELAY] {node.name} message heard - no MMRC response given: {preview}",
                                    is_system=True
                                )
...
if __name__ == "__main__":
    logger.info("Launching MMRC Luma 2.2.")
