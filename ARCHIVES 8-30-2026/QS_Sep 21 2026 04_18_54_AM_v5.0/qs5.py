...
VOICE_DISPLAY_OPTIONS = ["NATIVE UI"] + [KOKORO_VOICE_LABELS[v] for v in KOKORO_VOICE_IDS]
...
for _voice_id in KOKORO_VOICE_IDS:
    ...
    _label = KOKORO_VOICE_LABELS[_voice_id]
...
class QSUI:
    ...
    def _render_nodes(self):
        ...
        for name in keys:
            ...
            node._voice_combo.pack(side=tk.LEFT, padx=(5, 0))
        self._render_send_order()
