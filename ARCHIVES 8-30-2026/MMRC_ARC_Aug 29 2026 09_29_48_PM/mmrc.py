...
logger.info("=============================================================")
logger.info("MMRC Luma 2.3 STARTING")
...
class MMRCUI:
    def __init__(self, controller):
        self.root = tk.Tk()
        self.root.title("MMRC Luma 2.3 - Structural DOMAnalyzer")
    ...
    def _build_ui(self):
        tk.Label(
            self.root, text="MULTI-MIND RELAY CORE - Luma 2.3",
...
if __name__ == "__main__":
    logger.info("Launching MMRC Luma 2.3.")
