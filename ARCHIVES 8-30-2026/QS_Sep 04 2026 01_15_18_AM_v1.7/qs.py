...
#   - Relay display automatically returns to TOP after Fan-Out completes and the relay returns to IDLE.
...
class QSUI:
    ...
    def relay_state_changed(self, state):
        previous_state = self.relay_state
        self.relay_state = state
        self._update_relay_button()
        if previous_state == RelayState.COMPLETE and state == RelayState.IDLE:
