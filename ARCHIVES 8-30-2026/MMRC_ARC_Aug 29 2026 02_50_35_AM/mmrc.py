...
def initialize_archive():
    ...
    # Create a completely new empty log file first.
...
# Configure logging explicitly so the active archive LOG.txt is always used.
...
logger.info("=============================================================")
logger.info("MMRC Luma 1.0 STARTING")
