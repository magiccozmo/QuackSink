...
class QSUI:
    ...
    def _build_ui(self):
        ...
        # Preserve the established QS 2.2 archive-button row exactly.
        archive_button_bar = tk.Frame(archive_frame, bg="#121212")
        archive_button_bar.pack(fill=tk.X, pady=(2, 0))
        ...
        for label, command, bg, padx in archive_button_specs:
            tk.Button(
                archive_button_bar, text=label, command=command,
        ...
        # TOP/BOTTOM/FAN-OUT remain together directly above the relay display,
        # exactly as in the established QS UI.
