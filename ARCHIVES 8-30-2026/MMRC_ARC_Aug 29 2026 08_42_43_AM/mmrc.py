...
logger.info("=============================================================")
logger.info("MMRC Luma 1.7 STARTING")
...
class MMRCUI:
    def __init__(self, controller):
        self.root = tk.Tk()
        self.root.title("MMRC Luma 1.7 - Structural DOMAnalyzer")
...
class MMRCController:
    ...
    async def _get_response(self, page, node):
        ...
        # The newest message is authoritative. If it contains a complete MMRC
        # frame, return the frame payload. Otherwise return the complete newest
        # assistant text for diagnostics rather than an arbitrary old message.
        newest = messages[-1].strip()
        matches = list(re.finditer(r'🟩.*?🔚', newest, re.DOTALL))
        if matches:
...
if __name__ == "__main__":
    logger.info("Launching MMRC Luma 1.7.")
