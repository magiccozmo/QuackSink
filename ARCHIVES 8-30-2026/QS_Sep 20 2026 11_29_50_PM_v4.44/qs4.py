...
class QSController:
    ...
    async def _maybe_speak_node(self, page, node):
        ...
        if node.name == 'GPT':
            ...
            self.ui.log(f"[VOICE] {node.name} voice path is unavailable in QS 4.44.", is_system=True)
            return
            ...
            result = await page.evaluate(fr"""
                (() => {{
                    ...
                    const transientStatus = (value) => {{
                        ...
                        return /^(?:thinking[.…\.]*|generating[.…\.]*|loading[.…\.]*|typing[.…\.]*|processing[.…\.]*|searching[.…\.]*|working[.…\.]*)$/i.test(normalized);
                    }};
